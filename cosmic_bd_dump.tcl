...
################################################################
# This is a generated script based on design: cosmic_bd
#
...
proc write_mig_file_cosmic_bd_mig_7series_0_2 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>cosmic_bd_mig_7series_0_2</ModuleName>}
...
# End of write_mig_file_cosmic_bd_mig_7series_0_2()
...
proc create_root_design { parentCell } {
  ...
  write_mig_file_cosmic_bd_mig_7series_0_2 $str_mig_file_path
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins mig_7series_0/aresetn]
  ...
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_ports ui_clk_0]
  ...
  assign_bd_address -offset 0x00000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
